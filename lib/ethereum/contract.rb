  ...
  class Contract
    ...
    private
      ...
      def create_function_proxies
        ...
        @call_raw_proxy, @call_proxy, @encode_tx_proxy, @transact_proxy, @transact_and_wait_proxy =  call_raw_proxy.new, call_proxy.new, encode_tx_proxy.new, transact_proxy.new, transact_and_wait_proxy.new      end
